...
- **[ConfigurableFirmata](https://github.com/firmata/ConfigurableFirmata)** and **[Firmata protocol](https://github.com/firmata/protocol)**: sources for the SAM4E8E Firmata parser, digital I/O behavior, capability discovery, and USB CDC protocol transport.
