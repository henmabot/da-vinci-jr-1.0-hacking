...
- **[ConfigurableFirmata](https://github.com/firmata/ConfigurableFirmata)** and **[Firmata protocol](https://github.com/firmata/protocol)** — used to identify the digital GPIO and byte-stream facilities the later Firmata port will require.
